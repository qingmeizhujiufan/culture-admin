...
const queryListUrl = restUrl.ADDR + 'taste/queryCommentList';
const queryAdminCommentListUrl = restUrl.ADDR + 'taste/queryAdminCommentList';
const delUrl = restUrl.ADDR + 'taste/deleteComment';

class CommentTaste extends React.Component {
    constructor(props) {
        super(props);
...
CommentTaste.contextTypes = {
    router: PropTypes.object
}

export default CommentTaste;